  ...
  return (
    <>
      <div className="mb-7 bg-white dark:bg-[#242A38] px-6 py-4 md:mx-4 rounded-xl">
        <h2 className="dana-demi md:pr-3 text-lg sm:text-xl lg:text-2xl text-black dark:text-white">ثبت <span className="text-[#0f6b68] dana-extra">مقاله</span></h2>
          ...
          <form className="flex flex-col mt-4 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 w-full md:gap-x-4 lg:grid-cols-3 gap-y-4">
              <div className="flex bg-[#f3f4f6] dark:bg-[rgb(51,60,76)] h-[52px] rounded-xl gap-2 items-center justify-between w-full flex-row-reverse px-3">
                <input style={{ all: 'unset' }} type="text" className="!text-base dana-regular !text-gray-900 dark:!text-white !text-start !pl-10 !w-full !h-full" placeholder="نام مقاله" />
                <MdTitle className="text-2xl text-slate-400" />
              </div>
              <div className="flex bg-[#f3f4f6] dark:bg-[rgb(51,60,76)] h-[52px] rounded-xl gap-2 items-center justify-between w-full flex-row-reverse px-3">
                <input style={{ all: 'unset' }} type="text" className="!text-base dana-regular !text-gray-900 dark:!text-white !text-start !pl-10 !w-full !h-full" placeholder="توضیحات مقاله" />
      ...
      <div>
        <DataTable tableTitles={articleTitle} name={"مقالات"} />
      </div>
    </>
  )
}
