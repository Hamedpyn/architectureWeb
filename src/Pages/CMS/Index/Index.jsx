...
export default function Index() {
  ...
  const coursesTitle = [
    { title: 'شناسه', id: 1 },
    { title: 'نام', id: 2 },
    { title: 'نام کاربری', id: 3 },
    { title: 'ایمیل', id: 4 },
    { title: 'شماره تلفن', id: 5 },
  ]
  ...
  return (
    <>
      <div>
        <div className="mb-7">
          <div>
            <h1 className="dana-demi md:pr-3 text-lg sm:text-xl lg:text-2xl text-black dark:text-white">خوش اومدید، <span className="text-[#0f6b68] dana-extra">حامد جان</span></h1>
          </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="dana-demi text-lg text-gray-900 dark:text-white">
                      ...
                      <span className="text-base text-[#0f6b68] mr-1">تومان</span>
                    </span>
                    <div className={`flex items-center text-base md:text-lg gap-1 ${!link.color ? 'text-[#ef4444]' : 'text-[#0f6b68]'}`}>
        ...
        <DataTable tableTitles={coursesTitle} name={'افراد اخیرا ثبت شده'} />
