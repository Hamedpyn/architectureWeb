            ...
            <div className="px-4 lg:px-8">
                ...
                <form className="lg:p-6 lg:pl-0 mt-5 lg:mt-0 flex flex-col gap-7">
                    <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                        <div>
                            <span className="text-sm dana-medium text-black dark:text-white">نام و نام خانوادگی</span>
                        ...
                        <div>
                            <span className="text-sm dana-medium text-black dark:text-white">نام کاربری</span>
                            <div className={`bg-[#fff] dark:bg-[#242A38] mt-2 rounded py-1.5 flex justify-between items-center pr-2 pl-4 `}>
                        ...
                        <div>
                            <span className="text-sm dana-medium text-black dark:text-white">ایمیل</span>
                            <div className={`bg-[#fff] dark:bg-[#242A38] mt-2 rounded py-1.5 flex justify-between items-center pr-2 pl-4`}>
                        ...
                        <div>
                            <span className="text-sm dana-medium text-black dark:text-white">شماره تلفن</span>
                            <div className={`bg-[#fff] dark:bg-[#242A38] mt-2 rounded py-1.5 flex justify-between items-center pr-2 pl-4`}>
                        ...
                        <div>
                            <span className="text-sm dana-medium text-black dark:text-white">رمز جدید</span>
                            <div className={`bg-[#fff] dark:bg-[#242A38] mt-2 rounded py-1.5 flex justify-between items-center pr-2 pl-4 `}>
